...
using StringExtensions = IdProoServer.Extensions.StringExtensions;
using IdProoServer.Storage.Stores;
using IdProoServer.Storage.Extensions;

namespace IdProoServer.ResponseHandling;

/// <summary>
/// Default implementation of the discovery endpoint response generator
/// </summary>
/// <seealso cref="IdProoServer.ResponseHandling.IDiscoveryResponseGenerator" />
