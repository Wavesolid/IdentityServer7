...
namespace IdProoServer.Storage;
...
public class DefaultAuthorizationCodeStore : DefaultGrantStore<AuthorizationCode>,IAuthorizationCodeStore
{
    ...
    public DefaultAuthorizationCodeStore(
        ...
        : base(IdProoServer.IdentityServerConstants.PersistedGrantTypes.AuthorizationCode, store, serializer, handleGenerationService, logger)
    {
    }
