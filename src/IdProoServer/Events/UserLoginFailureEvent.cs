...
using static IdProoServer.Constants;

namespace IdProoServer.Events;

/// <summary>
/// Event for failed user authentication
/// </summary>
/// <seealso cref="IdProoServer.Events.Event" />
public class UserLoginFailureEvent : Event
{
    /// <summary>
    /// Initializes a new instance of the <see cref="T:IdProoServer.Events.UserLoginFailureEvent" /> class.
    /// </summary>
