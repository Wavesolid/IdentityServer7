...
public static class ScopeMappers
{
    ...
    /// <returns></returns>
    public static IdProoServer.Storage.Models.ApiScope ToModel(this Entities.ApiScope entity)
    {
        return entity == null ? null : Mapper.Map<IdProoServer.Storage.Models.ApiScope>(entity);
    }
    ...
    /// <returns></returns>
    public static Entities.ApiScope ToEntity(this IdProoServer.Storage.Models.ApiScope model)
    {
